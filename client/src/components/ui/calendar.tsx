...
export type CalendarProps = React.ComponentProps<typeof DayPicker> & {
  // Add custom prop to highlight days with masses
  massesOnDays?: number[] | Date[]
}
...
function Calendar({
  ...
  // Create a modifiers object for days with masses
  const modifiers = {
    hasMasses: massesOnDays as Date[]
  }

  // Custom styling for days with masses
